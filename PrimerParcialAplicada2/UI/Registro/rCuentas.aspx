<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rCuentas.aspx.cs" Inherits="PrimerParcialAplicada2.IU.Registro.rCuentas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="form-row justify-content-center">
        <aside class="col-sm-6">
            <div class="card">
                <div class="card-header text-uppercase text-center text-primary">Cuenta </div>
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <div class="container">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox class="form-control" ID="cuentaIdTextBox" type="number" Text="0" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <div class="container">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox class="form-control" ID="balanceTextBox" ReadOnly="true" type="number" Text="0" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
